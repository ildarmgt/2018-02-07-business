var MAIN__CANVAS = document.getElementsByClassName('main-c')[0]; // canvas dom
var MAIN__SPLASH = document.getElementsByClassName('main-splash')[0];
...
function resizeAndRefreshCanvas () {
  ...
  MAIN__CANVAS.width = MAIN__SPLASH.offsetWidth;
  MAIN__CANVAS.height = MAIN__SPLASH.offsetHeight; // .clientHeight with padding
